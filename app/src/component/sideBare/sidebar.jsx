...
<NavLink  className={({ isActive }) => (isActive ? "active-link" : "inactive-link")} to="/messageReseved" ><GoInbox size={20} /></NavLink>
<NavLink  className={({ isActive }) => (isActive ? "active-link" : "inactive-link")} to="/Corbeille" >< PiTrashSimple size={20} /></NavLink>
<NavLink  className={({ isActive }) => (isActive ? "active-link" : "inactive-link")} to="/Brouillons" ><FaFirstdraft size={20} /></NavLink>
